...
<div class="container">
    ...
    <div class="starter-template">
        ...
        <p class="lead">Abre esta url en una ventana privada u otro navegador para ser registrado como un nuevo usuario</p>
        ...
        <div class="alert alert-danger connection_alert" role="alert">
            ...
            Actualmente no hay conexión con el servidor. <br />
            <span class="error_type"></span>
            <span class="error_reconnect_msg">reconectando en</span>
        ...
        <div class="input-group client">
            ...
            <span class="input-group-btn">
                <button class="btn btn-default btn-send chat_btn" type="button">Enviar</button>
            </span>
        </div><!--/input-group -->
    </div>
